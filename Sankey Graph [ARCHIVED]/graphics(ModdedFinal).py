...
#My class for text that needs to be aligned
class Label(GraphicsObject):
    ...
    def draw(self, canvas):
        ...
        #tk.Label(canvas, text=self.getText(), font=("{} {} {}".format(f, s, b)), bg="grey").place(x=self.anchor.getX(), y=self.anchor.getY(), anchor=self.config["align"])
    ...
    def clone(self):
        other = Label(self.anchor, self.config['text'])
        other.config = self.config.copy()
        return other
    ...
    #Another method added on top of preexisting Text() methods
...
class Text(GraphicsObject):
    ...
    def setAlign(self, align):
        self._reconfig("align")
    # def getBox(self, canvas):
        # return self
        # return canvas.bbox(self)
